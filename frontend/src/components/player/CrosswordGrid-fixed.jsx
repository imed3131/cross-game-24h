        ...
        <div className="flex mb-2">
          ...
          {Array.from({ length: puzzle.cols || gridSize }, (_, colIndex) => (
            <div 
              ...
              className="w-8 h-8 flex items-center justify-center text-xs font-bold text-blue-600 bg-blue-50 border border-blue-200 rounded mx-0.5"
            >
              {colIndex + 1}
            </div>
          ))}
          ...
          <div className="flex flex-col mr-2">
            {Array.from({ length: puzzle.rows || gridSize }, (_, rowIndex) => (
              <div 
                ...
                className="w-8 h-8 flex items-center justify-center text-xs font-bold text-green-600 bg-green-50 border border-green-200 rounded mb-0.5"
              >
                {rowIndex + 1}
              </div>
            ))}
